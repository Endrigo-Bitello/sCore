...
public class Manager {
  ...
  static {
    try {
      ...
      Class<?> bungeeMain = Class.forName("dev.slasher.smartplugins.bungee.Bungee");
      ...
      try {
        ...
        Class<?> fakeManager = Class.forName("dev.slasher.smartplugins.player.fake.FakeManager");
        GET_NAME = Accessors.getMethod(player, "getName");
        GET_PLAYER = Accessors.getMethod(Class.forName("dev.slasher.smartplugins.player.Profile"), "findCached", String.class);
