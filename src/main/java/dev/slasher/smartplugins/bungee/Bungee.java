package dev.slasher.smartplugins.bungee;

import com.google.common.io.ByteArrayDataOutput;
import com.google.common.io.ByteStreams;
import dev.slasher.smartplugins.bungee.cmd.Commands;
import dev.slasher.smartplugins.bungee.listener.Listeners;
...
public class Bungee extends Plugin {
  ...
  public void onEnable() {
    ...
    getProxy().registerChannel("sCore");
  ...
  public void saveDefaultConfig() {
    for (String fileName : new String[] {"config", "roles", "utils"}) {
      File file = new File("plugins/sCore/" + fileName + ".yml");
      if (!file.exists()) {
   ...
   *
   * @param input The input to be copied.
   * @param out   The recipient file.
   */
