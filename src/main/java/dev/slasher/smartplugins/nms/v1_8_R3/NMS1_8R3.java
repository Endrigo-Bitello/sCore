package dev.slasher.smartplugins.nms.v1_8_R3;

import com.google.common.base.Preconditions;
import com.mojang.authlib.GameProfile;
import com.mojang.authlib.properties.Property;
import dev.slasher.smartplugins.nms.v1_8_R3.entity.EntityItem;
import dev.slasher.smartplugins.nms.v1_8_R3.entity.EntityNPCPlayer;
import dev.slasher.smartplugins.nms.v1_8_R3.entity.EntityStand;
import dev.slasher.smartplugins.nms.v1_8_R3.entity.HumanController;
import dev.slasher.smartplugins.nms.v1_8_R3.utils.PlayerlistTrackerEntry;
import dev.slasher.smartplugins.nms.v1_8_R3.utils.UUIDMetadataStore;
...
import dev.slasher.smartplugins.nms.interfaces.INMS;
import dev.slasher.smartplugins.nms.interfaces.entity.IArmorStand;
...
public class NMS1_8R3 implements INMS {
  ...
  public NMS1_8R3() {
    ...
    CLASS_TO_NAME.get(null).put(dev.slasher.smartplugins.nms.v1_8_R3.entity.EntityArmorStand.class, "kCore-ArmorStand");
    CLASS_TO_ID.get(null).put(dev.slasher.smartplugins.nms.v1_8_R3.entity.EntitySlime.class, 55);
    CLASS_TO_NAME.get(null).put(dev.slasher.smartplugins.nms.v1_8_R3.entity.EntitySlime.class, "kCore-Slime");
    CLASS_TO_ID.get(null).put(dev.slasher.smartplugins.nms.v1_8_R3.entity.EntityItem.class, 1);
    CLASS_TO_NAME.get(null).put(dev.slasher.smartplugins.nms.v1_8_R3.entity.EntityItem.class, "kCore-Item");
  ...
  public IArmorStand createArmorStand(Location location, String name, HologramLine line) {
    IArmorStand armor = line == null ? new EntityStand(location) : new dev.slasher.smartplugins.nms.v1_8_R3.entity.EntityArmorStand(((CraftWorld) location.getWorld()).getHandle(), line);
  ...
  public IItem createItem(Location location, ItemStack item, HologramLine line) {
    dev.slasher.smartplugins.nms.v1_8_R3.entity.EntityItem eitem = new dev.slasher.smartplugins.nms.v1_8_R3.entity.EntityItem(((CraftWorld) location.getWorld()).getHandle(), line);
  ...
  public ISlime createSlime(Location location, HologramLine line) {
    dev.slasher.smartplugins.nms.v1_8_R3.entity.EntitySlime slime = new dev.slasher.smartplugins.nms.v1_8_R3.entity.EntitySlime(((CraftWorld) location.getWorld()).getHandle(), line);
  ...
  public Hologram getHologram(Entity entity) {
    ...
    HologramLine e = null;
    if (en instanceof dev.slasher.smartplugins.nms.v1_8_R3.entity.EntityArmorStand) {
      e = ((dev.slasher.smartplugins.nms.v1_8_R3.entity.EntityArmorStand) en).getLine();
    } else if (en instanceof dev.slasher.smartplugins.nms.v1_8_R3.entity.EntitySlime) {
      e = ((dev.slasher.smartplugins.nms.v1_8_R3.entity.EntitySlime) en).getLine();
    } else if (en instanceof dev.slasher.smartplugins.nms.v1_8_R3.entity.EntityItem) {
